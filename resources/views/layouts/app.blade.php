                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        @endcan
                            @can("Dashboard list")
                                <li class="nav-item dropdown">
                                    <a id="roleDropdown" class="nav-link dropdown-toggle" href="{{route('Dashboard.index')}}" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                        {{ __("Dashboard") }}
                                    </a>
                                </li>
                            @endcan
                        ...
                        @else
                            ...
                            <li class="nav-item">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('myArticles') }}">
                                         {{ __('my Posts') }}
                                    </a>
