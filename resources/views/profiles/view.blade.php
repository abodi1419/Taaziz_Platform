...
<div class="container">
    <div class="row">
        <div class="col"><h2>{{$profile->student->user->name}} </h2></div>
{{--        <div class="col"><a href="{{route('student.edit',$user->student)}}">{{__('Edit')}}</a></div>--}}
    </div>

    <div class="row">
        <div class="col">{{$profile->major}}<br></div>

{{--        <div class="col"><a href="{{route('profile.edit',$user->student->profile)}}">{{__('Edit')}}</a></div>--}}
    </div>

    <div class="row">
        <div class="col">{{__('GPA').': '.$profile->gpa}}</div>
{{--        <div class="col"><a href="{{route('profile.edit',$profile)}}">{{__('Edit')}}</a></div>--}}
    </div>
...
{{--        <a class="col" href="{{route('skills.create')}}">{{__('Add')}}</a>--}}
    ...
    <hr>
    @if(count($skills=$profile->skills))
    <p>
        <ul>
...
{{--        <a class="col" href="{{route('projects.create')}}">{{__('Add')}}</a>--}}
    ...
    <hr>
    @if(count($projects=$profile->projects))
        <ul>
...
{{--        <a class="col" href="{{route('certifications.create')}}">{{__('Add')}}</a>--}}
    ...
    <hr>
    @if(count($certifications=$profile->certifications))
        <ul>
...
{{--        <a class="col" href="{{route('languages.create')}}">{{__('Add')}}</a>--}}
    ...
    <hr>
    @if(count($languages=$profile->languages))
        <p>
        <div class="row">
...
{{--        <a class="col" href="{{route('contacts.create')}}">{{__('Add')}}</a>--}}
    ...
    <hr>
    @if(count($contacts=$profile->contacts))
        <p>
        <div class="row">
